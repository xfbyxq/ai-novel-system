...
from .chapter_outline_mapper import ChapterOutlineMapper, ChapterOutlineTask, OutlineValidationReport
from .character_consistency_tracker import CharacterConsistencyTracker, CharacterProfile, ConsistencyValidation
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "components": {
                ...
                "foreshadowing": self.foreshadowing_report.to_dict() if self.foreshadowing_report else None,
                "prevention": self.prevention_report.to_dict() if self.prevention_report else None
            },
            "issues": self.issues,
...
class ContinuityIntegrationModule:
    ...
    def _extract_constraints_from_previous(
        ...
        if ending_state:
            constraints.append(ContinuityConstraint(
