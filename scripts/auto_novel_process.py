...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/Users/sanyi/code/python/novel_system/logs/auto_novel_process.log'),
...
class AutoNovelProcess:
    ...
    async def run_full_process(self, genre="玄幻", tags=["系统", "穿越"], platform="qidian"):
        """运行完整的小说创作流程
