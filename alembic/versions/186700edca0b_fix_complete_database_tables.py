...
def upgrade() -> None:
    ...
    if not table_exists('novels'):
        ...
        sa.Column('status', sa.Enum('planning', 'writing', 'completed', 'published', name='novelstatus', create_type=False), nullable=True),
    ...
    if not table_exists('chapters'):
        ...
        sa.Column('word_count', sa.Integer(), nullable=True),
        sa.Column('status', sa.Enum('draft', 'reviewing', 'published', name='chapterstatus', create_type=False), nullable=True),
        ...
        sa.Column('plot_points', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('foreshadowing', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('quality_score', sa.Float(), nullable=True),
        sa.Column('continuity_issues', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    ...
    if not table_exists('characters'):
        ...
        sa.Column('role_type', sa.Enum('protagonist', 'supporting', 'antagonist', 'minor', name='roletype', create_type=False), nullable=True),
        sa.Column('gender', sa.Enum('male', 'female', 'other', name='gender', create_type=False), nullable=True),
        ...
        sa.Column('status', sa.Enum('alive', 'dead', 'unknown', name='characterstatus', create_type=False), nullable=True),
    ...
    if not table_exists('generation_tasks'):
        ...
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('novel_id', sa.UUID(), nullable=False),
        sa.Column('task_type', sa.Enum('planning', 'writing', 'editing', 'batch_writing', name='tasktype', create_type=False), nullable=False),
        sa.Column('status', sa.Enum('pending', 'running', 'completed', 'failed', 'cancelled', name='taskstatus', create_type=False), nullable=True),
    ...
    if not table_exists('plot_outlines'):
        ...
        sa.Column('key_turning_points', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    if not table_exists('world_settings'):
        ...
        sa.Column('power_system', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('special_elements', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('raw_content', sa.Text(), nullable=True),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
        sa.ForeignKeyConstraint(['novel_id'], ['novels.id'], ondelete='CASCADE'),
