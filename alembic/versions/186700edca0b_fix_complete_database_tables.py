...
def upgrade() -> None:
    ...
    sa.Column('crawl_type', sa.String(length=50), nullable=False),
    sa.Column('config', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('status', sa.Enum('pending', 'running', 'completed', 'failed', 'cancelled', name='crawltaskstatus'), nullable=True),
    ...
    sa.Column('status', sa.Enum('planning', 'writing', 'completed', 'published', name='novelstatus'), nullable=True),
    ...
    sa.Column('word_count', sa.Integer(), nullable=True),
    sa.Column('status', sa.Enum('draft', 'reviewing', 'published', name='chapterstatus'), nullable=True),
    ...
    sa.Column('role_type', sa.Enum('protagonist', 'supporting', 'antagonist', 'minor', name='roletype'), nullable=True),
    ...
    sa.Column('status', sa.Enum('alive', 'dead', 'unknown', name='characterstatus'), nullable=True),
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('novel_id', sa.UUID(), nullable=False),
    sa.Column('task_type', sa.Enum('planning', 'writing', 'editing', 'batch_writing', name='tasktype'), nullable=False),
    ...
    sa.Column('comment_sentiment', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('trend_score', sa.Float(), nullable=True),
    sa.Column('data_date', sa.Date(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('crawler_task_id', sa.UUID(), nullable=True),
    ...
    sa.Column('word_count', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['crawler_task_id'], ['crawler_tasks.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
