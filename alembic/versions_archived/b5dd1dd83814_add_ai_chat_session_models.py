...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_ai_chat_sessions_scene'), 'ai_chat_sessions', ['scene'], unique=False)
    op.create_index(op.f('ix_ai_chat_sessions_session_id'), 'ai_chat_sessions', ['session_id'], unique=True)
