...
## 引言
本文件为小说系统的UI组件库开发指南，聚焦于Ant Design组件的集成与扩展，涵盖主题与样式定制、组件配置、业务组件设计规范、复用模式、测试策略以及可访问性支持。随着应用功能的增强，新增了智能章节范围选择、智能摘要生成、修订建议提取与应用等高级功能，为用户提供更加智能化的小说创作体验。
...
- [AIChatDrawer.tsx:1-1049](file://frontend/src/components/AIChatDrawer.tsx#L1-L1049)
...
- **AIChatDrawer**：右侧抽屉式AI对话与修订助手，支持会话管理、WebSocket流式输出、修订建议提取与应用、章节范围控制、智能摘要生成等高级功能。
...
### AIChatDrawer 聊天抽屉
- **设计目的**：提供AI对话、会话历史、修订建议提取与应用、章节范围控制、智能摘要生成等高级功能。
...
- **依赖关系**：依赖API模块（会话、消息、建议、修订、智能摘要）、小说与章节列表查询、更新接口。
...
**图表来源**
- [AIChatDrawer.tsx:1-1049](file://frontend/src/components/AIChatDrawer.tsx#L1-L1049)
- [aiChat.ts:1-269](file://frontend/src/api/aiChat.ts#L1-L269)
...
- **新增API依赖**：AIChatDrawer新增依赖aiChat.ts中的智能摘要和修订建议API。
...
## 结论
本UI组件库以Ant Design为基础，围绕小说业务场景提供了卡片、徽章、统计、抽屉与错误边界等核心组件。通过清晰的Props设计、统一的状态映射与格式化工具、完善的会话与修订流程，实现了良好的可维护性与扩展性。新增的智能章节范围选择、智能摘要生成、修订建议提取与应用等高级功能，显著提升了用户体验和创作效率。建议后续完善Storybook文档、自动化测试与可访问性支持，持续提升组件质量与团队协作效率。
