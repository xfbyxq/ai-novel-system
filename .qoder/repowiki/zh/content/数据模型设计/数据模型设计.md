...
- [alembic/env.py](file://alembic/env.py#L15-L30)
- [backend/services/generation_service.py](file://backend/services/generation_service.py#L27-L200)
- [backend/services/publishing_service.py](file://backend/services/publishing_service.py#L21-L200)
...
- 情节大纲（PlotOutline）
  - 关键字段：所属小说、结构类型、卷列表/主线/支线/关键转折点 JSONB、高潮章节、原始内容、时间戳。
  - 关系：一对一（小说唯一对应一个情节大纲），级联删除。
  - 约束：唯一约束 novel_id，JSONB 默认空字典/数组。
...
**章节来源**
- [core/models/novel.py](file://core/models/novel.py#L60-L65)
...
- [alembic/versions/5badc20e064a_initial_tables.py](file://alembic/versions/5badc20e064a_initial_tables.py#L74-L76)
- [alembic/versions/4b47062db094_add_douyin_crawl_types.py](file://alembic/versions/4b47062db094_add_douyin_crawl_types.py#L42-L48)
...
**章节来源**
- [core/models/novel.py](file://core/models/novel.py#L24-L57)
- [core/models/character.py](file://core/models/character.py#L12-L51)
- [core/models/chapter.py](file://core/models/chapter.py#L12-L37)
- [core/models/generation_task.py](file://core/models/generation_task.py#L12-L43)
- [core/models/publish_task.py](file://core/models/publish_task.py#L13-L44)
- [core/models/world_setting.py](file://core/models/world_setting.py#L11-L26)
- [core/models/plot_outline.py](file://core/models/plot_outline.py#L11-L24)
...
**章节来源**
- [backend/services/generation_service.py](file://backend/services/generation_service.py#L36-L200)
- [backend/services/publishing_service.py](file://backend/services/publishing_service.py#L32-L200)
...
**章节来源**
- [core/models/novel.py](file://core/models/novel.py#L24-L28)
- [core/models/chapter.py](file://core/models/chapter.py#L12-L16)
- [core/models/generation_task.py](file://core/models/generation_task.py#L19-L24)
- [core/models/publish_task.py](file://core/models/publish_task.py#L20-L26)
- [core/models/platform_account.py](file://core/models/platform_account.py#L13-L18)
...
**图示来源**
- [core/models/novel.py](file://core/models/novel.py#L60-L65)
- [core/models/character.py](file://core/models/character.py#L53-L54)
- [core/models/chapter.py](file://core/models/chapter.py#L39-L39)
- [core/models/generation_task.py](file://core/models/generation_task.py#L46-L46)
- [core/models/publish_task.py](file://core/models/publish_task.py#L49-L50)
- [core/models/chapter_publish.py](file://core/models/chapter_publish.py#L37-L38)
- [core/models/world_setting.py](file://core/models/world_setting.py#L28-L28)
- [core/models/plot_outline.py](file://core/models/plot_outline.py#L26-L26)
- [core/models/token_usage.py](file://core/models/token_usage.py#L24-L24)
- [core/models/platform_account.py](file://core/models/platform_account.py#L37-L37)
...
**章节来源**
- [alembic/env.py](file://alembic/env.py#L15-L30)
- [backend/services/generation_service.py](file://backend/services/generation_service.py#L198-L200)
- [backend/services/publishing_service.py](file://backend/services/publishing_service.py#L114-L138)

## 结论
该数据模型以小说为核心聚合根，围绕生成与发布两条主线构建，通过枚举、JSONB、UUID、数组与级联策略实现了高扩展性与强一致性。配合 Alembic 的版本化迁移与异步数据库连接，能够支撑从企划到发布的全流程自动化。建议在生产环境中补充软删除与归档策略、完善索引与缓存、持续监控任务状态与成本，以保障系统长期稳定运行。
...
- [core/models/generation_task.py](file://core/models/generation_task.py#L31-L46)
- [core/models/novel.py](file://core/models/novel.py#L52-L54)