...
- [docs/PRD_business.md](file://docs/PRD_business.md)
</cite>
...
- [llm/qwen_client.py:16-64](file://llm/qwen_client.py#L16-L64)
- [workers/celery_app.py:6-23](file://workers/celery_app.py#L6-L23)
- [backend/api/v1/__init__.py:11-28](file://backend/api/v1/__init__.py#L11-L28)
...
- [backend/api/v1/characters.py:24-203](file://backend/api/v1/characters.py#L24-L203)
- [backend/api/v1/chapters.py:29-200](file://backend/api/v1/chapters.py#L29-L200)
- [backend/api/v1/outlines.py:25-161](file://backend/api/v1/outlines.py#L25-L161)
- [backend/api/v1/ai_chat.py:44-235](file://backend/api/v1/ai_chat.py#L44-L235)
...
章节来源
- [backend/api/v1/__init__.py:7-26](file://backend/api/v1/__init__.py#L7-L26)
- [core/models/__init__.py:28-39](file://core/models/__init__.py#L28-L39)
...
图表来源
- [backend/api/v1/generation.py:72-101](file://backend/api/v1/generation.py#L72-L101)
...
- [workers/celery_app.py:6-23](file://workers/celery_app.py#L6-L23)
- [backend/api/v1/ai_chat.py:96-141](file://backend/api/v1/ai_chat.py#L96-L141)
...
- 系统特性与创新点
  - 多智能体协作：基于CrewAI的多Agent系统，实现专业化分工与协同
  - 一致性保障：角色、情节、世界观全程一致性跟踪，避免逻辑矛盾
  - 审查循环：Designer-Reviewer模式的质量控制机制
  - 上下文管理：智能上下文压缩与连续性传播
  - 多平台支持：预留发布集成接口，支持多平台同步发布
  - 成本控制：精细化的成本追踪与预算管理
  - 可扩展性：模块化设计，支持功能扩展与定制化开发

**更新说明**
根据代码库分析，PRD.md文件已被删除，相关内容已整合到`docs/PRD_business.md`文件中。该文件详细描述了系统的功能模块、智能体协作系统、页面结构、配置管理等内容，为系统提供了完整的业务需求说明。更新后的文档已移除了对PRD.md文件的引用，相关内容已整合到现有文档中。