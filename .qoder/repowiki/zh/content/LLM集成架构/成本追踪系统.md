...
**更新** 本版本新增了完整的CostTracker类和TokenUsage模型，实现了详细的token使用监控和成本追踪功能，包括章节级别成本分解和多代理成本统计。
...
**章节来源**
- [core/models/agent_activity.py:22-185](file://core/models/agent_activity.py#L22-L185)
