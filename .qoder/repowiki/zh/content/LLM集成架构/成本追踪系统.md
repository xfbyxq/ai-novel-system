...
## 更新摘要
**所做更改**
- 增强了GenerationService中的_cost_tracking功能，新增了按Agent分别统计token消耗和成本的高级功能
- 支持多Agent命名约定自动识别和成本分配，提供更精细的资源消耗监控能力
- 扩展了Agent活动记录器，支持按Agent维度的成本统计和分析
- 增强了成本追踪的章节级和类别级统计能力
- 完善了Agent活动的自动识别和成本分配机制
...
**更新** 本版本新增了GenerationService中的高级_cost_tracking功能，支持按Agent分别统计token消耗和成本，以及多Agent命名约定自动识别和成本分配能力。
...
**图示来源**
- [llm/cost_tracker.py:66-95](file://llm/cost_tracker.py#L66-L95)
...
**章节来源**
- [llm/cost_tracker.py:84-126](file://llm/cost_tracker.py#L84-L126)
