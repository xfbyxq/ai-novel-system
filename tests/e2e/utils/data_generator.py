...
class TestDataGenerator:
    ...
    def _setup_constants(self):
        ...
        self.CHARACTER_TYPES = [
            "protagonist", "supporting", "antagonist", "minor"
        ]
    ...
    def generate_novel_data(self, 
                          ...
                          length_type: Optional[str] = None) -> Dict:
        """
        生成小说测试数据
    ...
    def generate_platform_account_data(self,
    ...
    def generate_batch_chapters_data(self, 
                                   start_chapter: int = 1,
                                   end_chapter: int = 5) -> List[Dict]:
        """
        生成批量章节测试数据
...
def generate_batch_chapters_data(start_chapter: int = 1, end_chapter: int = 5) -> List[Dict]:
    """生成批量章节测试数据的便捷函数"""
